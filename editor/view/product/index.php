                  ...
                  <table id="tblData" class="table table-bordered table-middle" method="post">
                     ...
                     <tbody>
                        ...
                        <tr>
                           ...
                           <td class="text-center">
                              <a class="btn bg-blue btn-xs" href="<?= base_url_editor ?>/product/details/<?= $item['Id'] ?>"><i class="fa fa-eyes"></i> Xem</a>

                              <a class="btn bg-blue btn-xs" href="<?= base_url_editor ?>/product/edit/<?= $item['Id'] ?>"><i class="fa fa-edit"></i> Sửa</a>
                             
                              <form class="hidden" id="frmDelete_<?= $item['Id'] ?>" action="<?= base_url_editor ?>/product/delete" method="post">
