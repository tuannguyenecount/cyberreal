                    ...
                    <div class="box-body">
                        ...
                        <div class="col-md-8">
                            <table class="table table-border-none table-middle">
                                <tbody>
                                    <tr>
                                        <td class="col-md-3 text-right">Mật khẩu hiện tại</td>
                                        <td>
                                ...
                                <tfoot>
                                    <tr>
                                        ...
                                        <td>
                                             <button type="submit" class="btn bg-green btn-sm"><i class="fa fa-save"></i> Đổi mật khẩu</button>
                                            <a href="<?=base_url_editor?>/user" class = "btn btn-default btn-sm">Danh sách người dùng</a>
                                        </td>
                                    </tr>
                                </tfoot>
                            </table>
