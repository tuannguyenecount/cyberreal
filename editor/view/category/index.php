      ...
      <div class="col-xs-12">
         <div class="box">
            <div class="box-body">
               ...
               <p>
                  <a class="btn btn-success btn-xs" href="<?=base_url_editor?>/category/create">Thêm Mới</a>
               </p>
                <?php 
                  ...
                  <tbody>
                     ...
                     <tr>
                        ...
                        <td class="text-center">
                           ...
                           <a class="btn bg-blue btn-xs" href="<?= base_url_editor ?>/category/edit/<?= $item[0] ?>"><i class="fa fa-edit"></i> Sửa</a>
                          
                           <form class="hidden" id="frmDelete_<?= $item[0] ?>" action="<?= base_url_editor ?>/category/delete" method="post">
