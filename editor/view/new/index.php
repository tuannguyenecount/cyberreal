   ...
   <div class="row">
      <div class="col-xs-12">
         <div class="box">
            <div class="box-body">
               <p>
                  <a class="btn btn-primary btn-xs" href="<?= base_url_editor ?>/new/create">Viết bài mới</a>
               </p>
               ...
               <div class="table-responsive">
                  ...
                  <tbody>
                     ...
                     <tr>
                        ...
                        <td class="text-center">
                           <a class="btn bg-blue btn-xs" href="<?= base_url_editor ?>/new/edit/<?= $item['Id'] ?>"><i class="fa fa-edit"></i> Sửa</a>
                          
                           <form class="hidden" id="frmDelete_<?= $item['Id'] ?>" action="<?= base_url_editor ?>/new/delete" method="post">
