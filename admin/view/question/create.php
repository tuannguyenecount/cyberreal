                    ...
                    <div class="box-body">
                        ...
                        <div class="col-md-8">
                            <table class="table table-border-none table-middle">
                                <tbody>
                                    <tr>
                                        <td class="col-md-3 text-right">Mã câu hỏi</td>
                                        <td>
                                            <input type="text" value="<?= isset($Id) ? $Id : "" ?>"  name="Id" class="form-control"  />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="col-md-3 text-right">Nội dung câu hỏi</td>
                                        <td>
