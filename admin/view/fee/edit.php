                    ...
                    <div class="box-body">
                        ...
                        <div class="col-md-8">
                            <table class="table table-border-none table-middle">
                                <tbody>
                                    <tr>
                                        <td class="col-md-3 text-right">Tên loại phí</td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="number" min="1" value="<?= isset($_POST['SortOrder']) ? $_POST['SortOrder'] : $view_data['model']['SortOrder'] ?>"   step="1" name="SortOrder" class="form-control" />
                                    </tr>
                                </tbody>
                                <tfoot>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="<?=base_url_admin?>/fee" class = "btn btn-default btn-sm">Về danh sách</a>
                                        </td>
                                    </tr>
                                </tfoot>
                            </table>
