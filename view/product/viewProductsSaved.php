                  ...
                  <tr>
                     ...
                     <td class="align-middle text-center">
                        <div class="form-group mb-0 required">
                           <input type="text" class="form-control calendar" id="BookingForm" name="BookingForm" readonly="">
            ...
            <div class="row">
               <div class="col-md-4">
                  <div class="form-group field-bookingform-name">
                     <label class="control-label" for="bookingform-name">Họ và tên/ Tên công ty</label>
               ...
               <div class="col-md-4">
                  <div class="form-group field-bookingform-email">
                     <label class="control-label" for="bookingform-email">Email</label>
               ...
               <div class="col-md-4">
                  <div class="form-group field-bookingform-phone">
                     <label class="control-label" for="bookingform-phone">Điện thoại</label>
            ...
            <div class="row mt-1">
               <div class="col-md-8">
                  <div class="form-group field-bookingform-note">
                     <label class="control-label" for="bookingform-note">Ghi chú</label>
